		...
		<div class="form-group">
			<label for="inputLogradouro">Logradouro</label> <input type="text"
				...
				value="{{array.logradouro}} ${cliente.endereco.logradouro}" required>
		</div>
		<div class="form-group">
