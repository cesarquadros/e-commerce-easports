	...
	<div class="container-fluid" id="banner1">
		<div class="row">
			<div class="col-xs-4 col-sm-4 col-md-4">
				<a href="index.jsp"><img src="./imagens_projeto/logo2.png"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a
								href="{{logado ? '/e-commerce-easports/ClienteServlet?acao=minhaconta' : 'login.jsp' }}">{{logado
									? 'Minha conta' : 'Efetuar Login'}}</a></li>
							<li ng-if="logado"><a
