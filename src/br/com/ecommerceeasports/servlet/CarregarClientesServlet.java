...
public class CarregarClientesServlet extends HttpServlet {
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			listagemClientes = clienteDao.listAll();

			String json = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(listagemClientes);
			json = "{\"clientes\":" + json + "}";
