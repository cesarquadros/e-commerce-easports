...
/**
 * Ferramenta de busca de CEP, veja o mï¿½todo
 * {@link WebServiceCep#searchCep(String)} para maiores informaï¿½ï¿½es. <BR>
 * <BR>
 * Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do mï¿½todo estatico
 * {@link WebServiceCep#searchCep(String)}. <BR>
 * <BR>
 * Objeto contem todas as informaï¿½ï¿½es do XML, alï¿½m de informaï¿½ï¿½es
 ...
 * <a href="http://www.dom4j.org/dom4j-1.6.1/download.html" target="_blank">
 * dom4j.org</a> <BR>
 * <BR>
 * Exemplo de uso: <BR>
...
public final class WebServiceCep {
	...
	/**
	 * Classe utilitï¿½ria apenas encapsula o Iterator de elements da root
	...
	private static final class XmlEnums {
		...
		/**
		 * Busca um Enum {@link Xml} a partir do seu nome, a busca nï¿½o ï¿½
	...
	/**
	 * Mascara para a string url de conexï¿½o, onde <tt>"%s"</tt> ï¿½
	 ...
	 *             Quando hï¿½ problema na formaï¿½ï¿½o do documento XML.
	 * @throws MalformedURLException
	 *             Quando a hï¿½ problema no link url.
	 */
	 ...
	 * <a href="http://www.republicavirtual.com.br" target="_blank">
	 * republicavirtual.com.br</a>, retornando o resultado em um objeto
	 * {@link WebServiceCep}. <BR>
	 * <BR>
	 * Nï¿½o se faz necessï¿½rio formataï¿½ï¿½es, a string pode ser enviada em
	 * qualquer formataï¿½ï¿½o, pois sï¿½ serï¿½o consideradas os primeiros 8
	 * numeros da string. <BR>
	 * Por Exemplo: <BR>
	 * Uma <tt>{@link String} "14.568-910"</tt> ï¿½ automaticamente passada para
	 * <tt>"14568910"</tt>. <BR>
	 * Uma <tt>{@link String} "1%4#5?55%16a8&910"</tt> ï¿½ automaticamente
	 * passada para <tt>"14555168"</tt>, sï¿½ levando em conta os primeiros 8
	 * nï¿½meros.
	 * 
	 * @param cep
	 *            Nï¿½mero do cep a ser carregado. Sï¿½ serï¿½o considerados os
	 *            primeiros 8 nï¿½meros da {@link String} enviada. Todos os
	 *            caracters nï¿½o numï¿½ricos serï¿½o removidos, e a string
	 *            serï¿½ truncada caso seja maior que 8 caracters.
	...
	/**
	 * Privado para que seja invocado apenas atravï¿½s de
	...
	/*
	 * PRIVATE mï¿½todos set, usados pela classe Xml para setar o objeto
	 * CepWebService
	 */
	 ...
	 */
	/**
	 * Informa o cï¿½digo do resultado da pesquisa. <BR>
	 * Cï¿½digos conhecidos: <BR>
	 * <tt>-1</tt> : busca nï¿½o realizada <BR>
	 * <tt>0</tt> : cep nï¿½o encontrado <BR>
	 * <tt>1</tt> : cep econtrado <BR>
	 * <tt>-14</tt> : Site nï¿½o encontrado (pode ser por problemas na
	 * internet). <BR>
	 * <tt>-15</tt> : Nï¿½o foi possivel ler o documento xml <BR>
	 * <tt>-16</tt> : Erro na formaï¿½ï¿½o da url <BR>
	 ...
	 *         <tt>false</tt> - caso haja falhas, ou o cep enviado nï¿½o esteja
	 *         cadastrado.
	 */
	 ...
	 * 
	 * @return <tt>true</tt> - Caso o cep nï¿½o tenha cido encontrado. <BR>
	 ...
	 *         <tt>false</tt> - Caso nï¿½o haja falhas.
	 */
	...
	/**
	 * Pega a exceï¿½ï¿½o que ocorreu durante a busca, retorna null caso nï¿½o
	 * haja exceï¿½ï¿½es.
	 * 
	 * @return <tt>{@link Exception}</tt> - Caso ocorra falhas <BR>
	 *         <tt>null</tt> - Caso nï¿½o haja falhas.
	 */
